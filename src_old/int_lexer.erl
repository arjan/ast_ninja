-file("/home/arjan/.asdf/installs/erlang/21.2/lib/parsetools-2.1.8/include/leexinc.hrl", 0).
...
-file("src/int_lexer.xrl", 13).

-file("/home/arjan/.asdf/installs/erlang/21.2/lib/parsetools-2.1.8/include/leexinc.hrl", 14).
...
yystate(2, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(2, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 47 ->
...
-file("src/int_lexer.xrl", 7).
yyaction_0(TokenChars) ->
     { token, { value, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/1}).
-file("src/int_lexer.xrl", 8).
yyaction_1(TokenChars) ->
     { token, { operator, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_2/0}).
-file("src/int_lexer.xrl", 9).
yyaction_2() ->
     skip_token .

-file("/home/arjan/.asdf/installs/erlang/21.2/lib/parsetools-2.1.8/include/leexinc.hrl", 313).
