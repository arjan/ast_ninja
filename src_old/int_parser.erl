...
-file("src/int_parser.yrl", 12).

unwrap({_,V}) -> V.

-file("/home/arjan/.asdf/installs/erlang/21.2/lib/parsetools-2.1.8/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
yeccpars2_0(S, value, Ss, Stack, T, Ts, Tzr) ->
